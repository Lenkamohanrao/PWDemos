...
- Name: allurereports.spec.ts >> search test
- Location: tests\allurereports.spec.ts:18:5
            ...
            - generic [ref=e169]:
              - heading "14.1-inch Laptop" [level=2] [ref=e170]:
                - link "14.1-inch Laptop" [ref=e171] [cursor=pointer]:
                  - /url: /141-inch-laptop
              - generic "1528 review(s)" [ref=e172]
              - generic [ref=e175]:
...
```ts
  ...
  2  | 
  3  | test.beforeEach("lanuch url",async({page})=>{
> 4  | await page.goto("https://demowebshop.tricentis.com/");
  ...
  9  | const logo=page.locator("img[alt='Tricentis Demo Web Shop']")
  10 | await expect(logo).toBeVisible();
  11 | })
  12 | 
  13 | test("Title test",async({page})=>{
  14 | const test=page.title()
  15 | expect(await test).toContain("Demo Web Shop")
  16 | })
  17 | 
  18 | test("search test",async({page})=>{
  19 | await page.locator("#small-searchterms").fill("14.1-inch Laptop")
  20 | 
  21 | await page.locator("input[value='Search']").click();
  22 | 
  23 | })
  24 | 
  25 | 
